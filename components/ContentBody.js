      ...
      <div className="col-xl-3 col-sm-6">
        <div className="card">
          ...
          <div className="progress  rounded-0" style={{height: 4}}>
            <div className="progress-bar rounded-0 bg-secondary progress-animated" style={{width: '50%', height: 4}} role="progressbar">
      ...
      <div className="col-xl-3  col-sm-6">
        <div className="card">
          <div className="card-body">
            <div className="media align-items-center">
              <div className="media-body mr-3">
                <h2 className="fs-34 text-black font-w600">124,551</h2>
          ...
          <div className="progress  rounded-0" style={{height: 4}}>
            <div className="progress-bar rounded-0 bg-secondary progress-animated" style={{width: '90%', height: 4}} role="progressbar">
      ...
      <div className="col-xl-3  col-sm-6">
        <div className="card">
          <div className="card-body">
            <div className="media align-items-center">
              <div className="media-body mr-3">
                <h2 className="fs-34 text-black font-w600">442</h2>
          ...
          <div className="progress  rounded-0" style={{height: 4}}>
            <div className="progress-bar rounded-0 bg-secondary progress-animated" style={{width: '30%', height: 4}} role="progressbar">
      ...
      <div className="col-xl-3  col-sm-6">
        <div className="card">
          <div className="card-body">
            <div className="media align-items-center">
              <div className="media-body mr-3">
                <h2 className="fs-34 text-black font-w600">$5,034</h2>
          ...
          <div className="progress  rounded-0" style={{height: 4}}>
            <div className="progress-bar rounded-0 bg-secondary progress-animated" style={{width: '94%', height: 4}} role="progressbar">
        ...
        <div className="row">
          ...
          <div className="col-xl-6 col-xxl-12 col-md-6">	
            <div className="card">
              ...
              <div className="card-body pb-0">
                ...
                <div className="d-flex align-items-center">
                  <svg className="mr-3" width={30} height={19} viewBox="0 0 30 19" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="col-xl-12">	
            <div className="card rated-doctors">
              <div className="card-header border-0 pb-0">
                <h3 className="fs-20 text-black mb-0 mr-auto">Top Rated Doctors</h3>
                <a href="javascript:void(0)" className="btn-link">More &gt;&gt;</a>
              </div>
              <div className="card-body">
                <div className="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
                  <div className="d-flex align-items-center mr-auto pr-2">
                    <span className="num mr-sm-4 mr-3">#1</span>
                    <img src={"images/users/1.jpg"} className="img-1 mr-sm-4 mr-3" alt />
                    <div>
                      <h4 className="mb-sm-2 mb-1"><a href="doctor.html" className="text-black">Dr. Samantha Queque</a></h4>
                      <span className="fs-14 text-primary font-w600">Gynecologist</span>
                    </div>
                  </div>
                  <div className="text-sm-right mt-sm-0 mt-3 star-review">
                    <ul>
                ...
                <div className="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
                  <div className="d-flex align-items-center mr-auto pr-2">
                    <span className="num mr-sm-4 mr-3">#2</span>
                    <img src={"images/users/2.jpg"} className="img-1 mr-sm-4 mr-3" alt />
                    <div>
                      <h4 className="mb-sm-2 mb-1"><a href="doctor.html" className="text-black">Dr. Samuel Jr.</a></h4>
                      <span className="fs-14 text-primary font-w600">Gynecologist</span>
                    </div>
                  </div>
                  <div className="text-sm-right mt-sm-0 mt-3 star-review">
                    ...
                    <span className="fs-14 text-black">221 reviews</span>
                  </div>
                </div>
                <div className="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
                  <div className="d-flex align-items-center mr-auto pr-2">
                    <span className="num mr-sm-4 mr-3">#3</span>
                    <img src={"images/users/3.jpg"} className="img-1 mr-sm-4 mr-3" alt />
                    <div>
                      <h4 className="mb-sm-2 mb-1"><a href="doctor.html" className="text-black">Dr. Jennifer Ruby</a></h4>
                      <span className="fs-14 text-primary font-w600">Gynecologist</span>
                    </div>
                  </div>
                  <div className="text-sm-right mt-sm-0 mt-3 star-review">
                    ...
                    <span className="fs-14 text-black">181 reviews</span>
                  </div>
                </div>
                <div className="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
                  <div className="d-flex align-items-center mr-auto pr-2">
                    <span className="num mr-sm-4 mr-3">#4</span>
                    <img src={"images/users/4.jpg"} className="img-1 mr-sm-4 mr-3" alt />
                    <div>
                      <h4 className="mb-sm-2 mb-1"><a href="doctor.html" className="text-black">Dr. Abdul Aziz Lazis</a></h4>
                      <span className="fs-14 text-primary font-w600">Gynecologist</span>
                    </div>
                  </div>
                  <div className="text-sm-right mt-sm-0 mt-3 star-review">
                ...
                <div className="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
                  <div className="d-flex align-items-center mr-auto pr-2">
                    <span className="num mr-sm-4 mr-3">#5</span>
                    <img src={"images/users/5.jpg"} className="img-1 mr-sm-4 mr-3" alt />
                    <div>
                      <h4 className="mb-sm-2 mb-1"><a href="doctor.html" className="text-black">Dr. Alex Siauw</a></h4>
                      <span className="fs-14 text-primary font-w600">Gynecologist</span>
                    </div>
                  </div>
                  <div className="text-sm-right mt-sm-0 mt-3 star-review">
                    ...
                    <span className="fs-14 text-black">176 reviews</span>
                  </div>
                </div>
                <div className="d-sm-flex pb-0 align-items-center">
                  <div className="d-flex align-items-center mr-auto pr-2">
                    <span className="num mr-sm-4 mr-3">#6</span>
                    <img src={"images/users/1.jpg"} className="img-1 mr-sm-4 mr-3" alt />
                    <div>
                      <h4 className="mb-sm-2 mb-1"><a href="doctor.html" className="text-black">Dr. Abdul Aziz Lazis</a></h4>
                      <span className="fs-14 text-primary font-w600">Gynecologist</span>
