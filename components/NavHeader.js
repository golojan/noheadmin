        ...
        <ul className="navbar-nav header-right">
          <li className="nav-item dropdown notification_dropdown">
            ...
            <div className="dropdown-menu dropdown-menu-right">
              ...
              <a className="all-notification" href="javascript:void(0)">See all notifications <i className="ti-arrow-right" /></a>
            </div>
          </li>
          <li className="nav-item dropdown notification_dropdown">
          ...
          <li className="nav-item dropdown notification_dropdown">
            ...
            <div className="dropdown-menu dropdown-menu-right p-3">
              <div id="DZ_W_TimeLine1" className="widget-timeline dz-scroll style-1 height370">
                <ul className="timeline">
                  <li>
